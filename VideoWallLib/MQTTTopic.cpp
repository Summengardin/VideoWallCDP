...
/*!
  \class VideoWallLib::MQTTTopic
  \inmodule VideoWallLib

  \section1 Usage

  Add documentation for MQTTTopic here.
*/
...
*/
void MQTTTopic::Create(const char* fullName)
{
    CDPComponent::Create(fullName);
    Retain.Create("Retain",this);
    QoS.Create("QoS",this);
    Topic.Create("Topic",this);
    Payload.Create("Payload",this);
}
...
/*!
  ...
  Note, that this function is normally filled automatically by the code generator.
*/
void MQTTTopic::CreateModel()
{
    CDPComponent::CreateModel();

    RegisterStateProcess("Null", (CDPCOMPONENT_STATEPROCESS) &MQTTTopic::ProcessNull, "Initial Null state");
}
...
/*!
  ...
  Note, that this function is normally filled automatically by the code generator.
*/
void MQTTTopic::Configure(const char* componentXML)
{
