...
/*!
  \class VideoWallLib::OSD
  \inmodule VideoWallLib

  \section1 Usage

  Add documentation for OSD here.
*/
...
*/
void OSD::Create(const char* fullName)
{
...
/*!
  ...
  Note, that this function is normally filled automatically by the code generator.
*/
void OSD::CreateModel()
{
    CDPComponent::CreateModel();

    RegisterStateProcess("Null", (CDPCOMPONENT_STATEPROCESS)&OSD::ProcessNull, "Initial Null state");
}
...
/*!
  ...
  Note, that this function is normally filled automatically by the code generator.
*/
void OSD::Configure(const char* componentXML)
{
