...
/*!
  \class VideoWallLib::MQTTHandler
  \inmodule VideoWallLib

  \section1 Usage

  Add documentation for MQTTHandler here.
*/
...
*/
void MQTTHandler::Create(const char* fullName)
{
...
/*!
  ...
  Note, that this function is normally filled automatically by the code generator.
*/
void MQTTHandler::CreateModel()
{
    CDPComponent::CreateModel();

    RegisterStateProcess("Null", (CDPCOMPONENT_STATEPROCESS)&MQTTHandler::ProcessNull, "Initial Null state");
}
...
/*!
  ...
  Note, that this function is normally filled automatically by the code generator.
*/
void MQTTHandler::Configure(const char* componentXML)
{
